...
(function(O, pa) {
	...
	function ra(a) {
		for (var b = K(a), c = Wa(a); c && 0 <= ["table", "td", "th"].indexOf(M(c)) && "static" === P(c).position;) c = Wa(c);
	...
	function S(a, b, c, d, e, f, g, l) {
		...
		k.ctx = c ? c(a, b.props || {}, function(q, n) {
			...
			if (k.ctx && e(k.ctx[q], k.ctx[q] = r)) {
				...
				p && (-1 === a.$$.dirty[0] && (va.push(a), Pa || (Pa = !0, Xb.then(ob)), a.$$.dirty.fill(0)), a.$$.dirty[q / 31 | 0] |= 1 << q % 31)
			}
			return n
		}) : [];
		k.update();
	...
	function Yb(a) {
		...
		return {
			c() {
				...
				B(b, "class", d = `${a[1]||""} btn ${a[4]?"btn-tour":""}`);
				b.disabled = a[2];
				B(b, "tabindex", "0")
			},
			m(g, l) {
			...
			p(g, l) {
				...
				l & 18 && d !== (d = `${a[1]||""} btn ${a[4]?"btn-tour":""}`) && B(b, "class", d);
				l & 4 && (b.disabled = a[2])
			},
			i: G,
			o: G,
	...
	function ac(a) {
		...
		return {
			...
			p(e, f) {
				[f] = f;
				e[1] ? d ? (d.p(e, f), f & 2 && z(d, 1)) : (d = rb(e), d.c(), z(d, 1), d.m(b, null)) : d && (aa(), C(d, 1, 1, () => {
					d = null
				}), ca())
			},
			i(e) {
...
Z`)
		...
		zc = function(a) {
			...
			defaultModifiers: [{
				...
				fn: function(a) {
					...
					null != b.modifiersData.popperOffsets && (b.styles.popper = Object.assign({}, b.styles.popper, Za(Object.assign({}, a, {
	...
	class Ra extends Qa {
		...
		_setupElements() {
			...
			}(d = this.tour && this.tour.options && this.tour.options.defaultStepOptions) && (c = kb(d, c));
			c = kb(this.options, c);
	...
	class Cc extends Qa {
		...
		show(a, b) {
			void 0 === a && (a = 0);
			void 0 === b && (b = !0);
			if (a = qa(a) ? this.getById(a) : this.steps[a]) this._updateStateBeforeShow(), Z(a.options.showOn) && !a.options.showOn() ? this._skipStep(a, b) : (this.trigger("show", {
				step: a,
